...
export async function connectToDatabase() {
    ...
    const { DB_CONN_STRING, DB_NAME, ORGANISATION_COLLECTION_NAME, MEASUREMENT_POINT_COLLECTION_NAME } = process.env;
    ...
    console.log(`Successfully connected to database: ${db.databaseName} and collections: (measurementConfigs: ${organisationsCollection.collectionName}, measurementPoints: ${measurementPointsCollection.collectionName}`);
}
